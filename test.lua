...
describe("space_split", function()
	it("fails if arguments are incorrect", function()
		assert.has_error(function() mfr.space_split() end)
		assert.has_error(function() mfr.space_split(12) end)
		assert.has_error(function() mfr.space_split({}) end)
	end)
	it("works", function()
		assert.are_same({"text", "text"}, mfr.space_split("text text"))
	end)
end)